...
var _src = '.' + fs.separator + 'comparisonBase';
var _results = '.' + fs.separator + 'comparisonResults' + fs.separator + currentDate.toISOString(); // for backwards compatibility results and src are the same - but you can change it!
